...
path = '../fake_detect_record/resnet101_scheduler_0.0001by0.1'
try :
    shutil.rmtree(path)
except:
    pass
...
total_dataset = torchvision.datasets.ImageFolder(root='/home/capstone_ai1/kong/processed/', transform = transform)
...
# ---------------------- #
            ...
            if (epoch * len(train_loader) + i)%10000 ==9999:
                scheduler.step()
