...
from ArcMarginProduct_For_Test import *
import copy
import time
import os
...
cap = cv.VideoCapture('June_30.mp4')
wanted = 'June'
...
while True:
    ...
    for face in dets:
        fa = FaceAligner(predictor,desiredLeftEye=(0.3, 0.3), desiredFaceWidth=112)
