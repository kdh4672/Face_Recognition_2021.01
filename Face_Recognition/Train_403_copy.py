...
path = './new_pth_folder/original_0.001'
...
#load data
total_dataset=CustomDataset(root_dir='403', transform = transforms)
...
# m_scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[30,60,90], gamma=0.3)
# l_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer=optimizer,
#                                          T_max=20,
#                                          eta_min=0)
breaker = False
